    ...
    <section className="max-w-[1440px] mx-auto md:px-4 lg:px-8 xl:px-12 md:py-4 lg:py-6 xl:py-8">
      <div className="relative md:rounded-2xl overflow-hidden bg-[#F0EBE3] min-h-[340px] sm:min-h-[400px] lg:h-[450px] lg:min-h-[450px] flex flex-col md:flex-row items-center group w-full">
        ...
        <div className="relative z-10 p-4 pt-6 pb-6 sm:p-6 sm:pt-24 sm:pb-8 md:p-16 xl:p-24 max-w-2xl xl:max-w-3xl mt-auto md:mt-0 w-full md:w-auto flex-1 flex flex-col justify-center">
          <span className="inline-block px-2 py-0.5 sm:px-3 sm:py-1 bg-[#E8F5E9] text-brand-emerald rounded-md text-[9px] sm:text-xs md:text-sm font-semibold mb-3 sm:mb-3 md:mb-4 xl:mb-6 shadow-sm w-max">
            ঈদ কালেকশন ২০২৩
          </span>
          <h1 className="text-2xl sm:text-3xl md:text-6xl xl:text-7xl font-heading font-bold text-brand-dark leading-[1.1] mb-2 sm:mb-3 md:mb-4 xl:mb-6 tracking-tight">
            ঈদ হোক<br/>
            <span className="text-[#888888]">আনন্দময়</span><br/>
            <span className="text-[#888888]">ও স্টাইলিশ</span>
          </h1>
          <p className="text-gray-600 text-[10px] sm:text-sm md:text-lg xl:text-xl mb-4 sm:mb-6 md:mb-8 xl:mb-10 max-w-[180px] sm:max-w-xs md:max-w-md xl:max-w-lg font-medium leading-snug">
            প্রিমিয়াম কোয়ালিটির পাঞ্জাবি,<br/> শাড়ি ও আরও অনেক কিছু
          </p>
          
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 md:gap-4">
            <button className="bg-[#125838] text-white px-4 sm:px-6 md:px-8 py-1.5 sm:py-2.5 md:py-3.5 rounded text-[10px] sm:text-sm md:text-base font-medium hover:bg-brand-dark transition-colors">
              এখনই কিনুন
            </button>
            <button className="bg-white text-brand-dark px-3 sm:px-6 md:px-8 py-1.5 sm:py-2.5 md:py-3.5 rounded text-[10px] sm:text-sm md:text-base font-medium hover:bg-gray-50 transition-colors shadow-md border border-gray-200 hidden sm:block">
              সব কালেকশন দেখুন
            </button>
          </div>
        </div>
